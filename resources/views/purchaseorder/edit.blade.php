                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body p-4 row g-3">
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group">
                                                    <select class="form-select party-ajax" data-party-type='customer' data-placeholder="Select Customer" id="party_id" name="party_id">
                                                        <!--<x-option-default-party-selected partyType='customer' selected="{{ $order->customer_id }}" />-->
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group">                                                  
                                                     <x-dropdown-sales-representatives  dropdownName="representative_id" selected="{{ $order->representative_id }}"/>
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <x-label for="order_date" name="{{ __('app.date') }}" />
                                                <div class="input-group mb-3">
                                                    <x-input type="text" additionalClasses="datepicker" name="order_date" :required="true" value="{{ $order->po_date }}"/>
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <div class="input-group mb-3">
                                                    <x-input type="text" additionalClasses="datepicker-edit" name="due_date" :required="true" value="{{ $order->due_date }}"/>
                                                    <span class="input-group-text" id="input-near-focus" role="button"><i class="fadeIn animated bx bx-calendar-alt"></i></span>
                                                </div>
                                            </div>
