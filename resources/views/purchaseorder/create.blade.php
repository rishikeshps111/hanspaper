...
@section('content')
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="row">
                <form class="g-3 needs-validation" id="invoiceForm" action="{{ route('purchaseorders.store') }}"
                                        ...
                                        <table class="table mb-0 table-striped table-bordered" id="invoiceItemsTable">
                                            <thead>
                                                <tr class="text-uppercase">
                                                    ...
                                                    <th scope="col" style="width: 200px; min-width: 200px !important; max-width: 200px !important;">
                                                        {{ __('app.qty') }}</th>
