@extends('layouts.app')
@section('title', __('Create Representative'))
		@section('content')
		<!--start page wrapper -->
					...
					<div class="col-12 col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body p-4">
                                <form class="row g-3 needs-validation" id="employeeForm" action="{{ route('representative.store') }}" enctype="multipart/form-data">
                                    {{-- CSRF Protection --}}
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <x-input type="text" name="full_name" :required="true" value=""/>
                                    </div>
                                    <div class="col-md-6">
...
@section('js')
<script src="{{ versionedAsset('custom/js/salesrepresentative/representative.js') }}"></script>
@endsection
