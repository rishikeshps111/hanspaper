					...
					<div class="col-12 col-lg-12">
                        <div class="card">
                            <div class="card-header px-4 py-3">
                                <h5 class="mb-0">{{ __('Employee Details') }}</h5>
                            </div>
                            <div class="card-body p-4">
                                <form class="row g-3 needs-validation" id="employeeForm" action="{{ route('employee.store') }}" enctype="multipart/form-data">
                                    {{-- CSRF Protection --}}
...
@section('js')
<script src="{{ versionedAsset('custom/js/employees/employee.js') }}"></script>
@endsection
