...
@section('content')
    ...
    <div class="page-wrapper">
        <div class="page-content">
            <x-breadcrumb :langArray="['Report', 'Packed By Report']" />
            <div class="row">
                <div class="col-12 col-lg-12">
                    <div class="card">
                        <div class="card-header px-4 py-3">
                            <h5 class="mb-0">{{ __('Packed By Report') }}</h5>
                        </div>
                        <div class="card-body p-4 row g-3">
                            <div class="col-md-3">
                                <label>Employee</label>
                                <select id="packed_by" class="form-control single-select-clear-field">
...
@section('js')
    ...
    <script>
        document.getElementById('generate_report').addEventListener('click', function() {
            const employeeId = document.getElementById('packed_by').value;
            ...
            fetch(`{{ route('report.packed_by.data') }}`, {
                    method: 'POST',
                    headers: {
