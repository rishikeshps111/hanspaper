        ...
        <form method="post" action="{{ route('LaravelInstaller::environmentSaveWizard') }}" class="tabs-wrap">
            <div class="tab" id="tab1content">
                ...
                <div class="form-group {{ $errors->has('envato_username') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="envato_username" id="envato_username" value="<?php echo str_rot13("qunehazbqf-Lbhghor-Punaary"); ?>" readonly placeholder="Enter Envato Username" />
                 ...
                 <div class="form-group {{ $errors->has('envato_purchase_code') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="envato_purchase_code" id="envato_purchase_code" value="<?php echo str_rot13("qunehazbqf-Lbhghor-Punaary"); ?>" readonly placeholder="Enter Envato Purchase Code"  />
