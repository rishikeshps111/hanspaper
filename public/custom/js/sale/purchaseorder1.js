...
function addRowToInvoiceItemsTable(recordObject, loadedFromUpdateOperation = false) {
    ...
    var inputQuantity = '<input required type="number" name="quantity[' + currentRowId + ']" class="form-control" value="">';


    var current_stock = '<input type="hidden" name="stock[' + currentRowId + ']" class="form-control" value="' + recordObject.current_stock + '">' + recordObject.current_stock;
    ...
    var remarks = '<textarea rows="1" type="text" name="remarks[' + currentRowId + ']" id="remarks-' + currentRowId + '" class="form-control" placeholder="Production Remarks" style="height: 200px;" required></textarea>';

    var pakingremarks = '<textarea rows="1" type="text" name="pakingremarks[' + currentRowId + ']" id="pakingremarks-' + currentRowId + '" class="form-control" placeholder="Packing Remarks" required style="height: 200px;"></textarea>';

    var dispatchremarks = '<textarea rows="1" type="text" name="dispatchremarks[' + currentRowId + ']" id="dispatchremarks-' + currentRowId + '" class="form-control" placeholder="Dispatch Remarks" style="height: 200px;" required></textarea>';
...
itemSearchInputBoxId.autocomplete({
    ...
    return $("<li>")
        ...
        .append(`<div style="display: flex; align-items: center;">
                        ...
                        <span style="flex: 1; text-align: left;">${item.category}</span>
                     </div>`)
        .appendTo(ul);
};
