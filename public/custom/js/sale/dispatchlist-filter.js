  ...
  let currentURL = window.location.href;
    ...
    function loadDatatables() {
        ...
        var table = tableId.DataTable({
            ...
            method: 'get',
            ajax: {
                url: baseURL + '/dispatch/datatable-filter-list',
...
this.api().columns([3]).every(function() {
    ...
    var select = $('<br/><select class="form-select form-select-sm select2"><option value="">All Customers</option></select>')
        ...
        .on('change', function() {
            ...
            table.ajax.url(baseURL + '/dispatch/datatable-filter-list?' + $.param(filters)).load();
        })
    ...
    if (initialCustomer) {
        select.val(initialCustomer);
            ...
            $.get(baseURL + '/dispatch/uniquecustomerswithstatus/'+urlstatus+'', function(data) {
