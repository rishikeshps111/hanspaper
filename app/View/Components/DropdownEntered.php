...
class DropdownEntered extends Component
{
    /**
     * Roles array
     *
    ...
    public function __construct($selected = null, $disabled = false,$showSelectOptionAll = false, $name = 'id')
    {
        $this->users = Employee::select('id','full_name')->get();
        $this->selected = $selected;
    ...
    {
        return view('components.dropdown-entered');
    }
}
