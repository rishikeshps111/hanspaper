...
class UserPermissionsController extends Controller
{
    ...
    public function createPermission() : View {
         $groups = PermissionGroup::where('status', 1)->pluck('id', 'name')->toArray();
        return view('roles-and-permissions.permission.create',compact('groups'));
    }
    ...
    //      $groups = PermissionGroup::pluck('id', 'name')->toArray(); 
    //     $permission = Permission::find($id);

    //     return view('roles-and-permissions.permission.edit', compact('permission','groups'));
    // }
    public function editPermission($id) : View {
        $groups = PermissionGroup::where('status', 1)->pluck('id', 'name')->toArray();
        $permission = Permission::find($id);
